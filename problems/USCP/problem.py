...
class USCP:
    ...
    def readInstance(self, instance):
        ...
        instance_path = os.path.join(script_dir, "Instances", instance + ".txt")
    ...
    def obtenerOptimoUSCP(self, archivoInstancia):
        ...
        return orden.get(clave_instancia, [None])[
            1
        ]  # Devuelve el óptimo si existe, sino None
    ...
    def repairComplex(self, solution):
        ...
        while not feasible:  # repetimos hasta que la solución sea factible
            ...
            cnc = (
                r_no_cubiertas @ set_sparse
            )  # Operador @ realiza np.dot en formato disperso
